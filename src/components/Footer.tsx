      ...
      <div className="flex flex-col justify-between gap-y-8 xl:flex-row">
        <div className="flex flex-col items-start gap-4 md:flex-row lg:gap-2">
          <div className="mt-8 flex items-start justify-start gap-2 md:mt-0">
            <Logo src="https://metalogic.com.np/metalogo.png" alt="logo" />
            
            <h1 className="mb-4 flex flex-col text-2xl font-bold md:hidden">
              <span className="__className_1e998c tracking-widest metalogic">MetaLogic</span>
          ...
          <div className="flex w-full flex-col justify-between md:flex-row xl:flex-col">
            <h1 className="mb-4 hidden md:block ">
              <span className="__className_1e998c text-3xl font-semibold tracking-widest">MetaLogic</span>
              <br />
          ...
          <div>
            ...
            <ul className="flex gap-4 text-sm">
              <li className="rounded-full border-2 p-2">
                <a aria-label="whatsapp messaging direct link" target="_blank" href="https://wa.me/9851353599">
              ...
              <li className="rounded-full border-2 p-2">
                <a aria-label="our facebook page link" target="blank" href="https://www.facebook.com/metalogicsoftware">
